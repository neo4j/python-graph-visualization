...
In this section, we will discuss how to render a link:{api-uri}/visualization-graph[`VisualizationGraph` object]
...
reference: link:{api-uri}/visualization-graph/#neo4j_viz.VisualizationGraph.render[neo4j_viz.VisualizationGraph.render()].
...
Refer to the xref:getting-started.adoc[] and the link:/tutorials/index[tutorials] for
